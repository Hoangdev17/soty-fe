  ...
  <UModal v-model:open="isOpen" class="max-w-3xl">
    ...
    <template #body>
      ...
      <div
        ...
        class="max-h-[32rem] overflow-y-auto scrollbar-hide"
      >
        <!-- Nametag Preview Section - Mobile: Top and Sticky -->
        <div
          v-if="isMobile"
          class="sticky top-0 z-10 pb-64 bg-white dark:bg-gray-900"
        >
            ...
            >
              ...
              <div class="flex gap-1 relative z-10">
                ...
                <div
                  class="w-6 h-6 bg-gray-700/50 rounded flex items-center justify-center"
                >
                  <UIcon name="i-lucide-phone" class="w-3 h-3 text-gray-300" />
                </div>
                <div
                  class="w-6 h-6 bg-gray-700/50 rounded flex items-center justify-center"
                >
          ...
          <div v-if="!isMobile" class="w-80 self-start">
            <h4 class="text-sm font-medium mb-4 text-center">
              Xem trước Nametag
            </h4>
            <div class="flex flex-col items-center space-y-4">
