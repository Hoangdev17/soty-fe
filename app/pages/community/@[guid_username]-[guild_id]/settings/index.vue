...
<template>
  ...
  >
    ...
    <template #default>
      ...
      >
        <div class="mb-4">
          <h2 class="text-xl font-semibold mb-2 text-white">Server Overview</h2>
          <p class="text-gray-400 text-sm">
            Manage and customize your server settings
          </p>
        </div>

        <UCard class="bg-dark-800 border-dark-700 overflow-hidden mb-4">
          <!-- Banner inside card -->
          <div class="relative">
            <CommunityBanner
            ...
            <!-- Avatar overlay -->
            <div
              class="absolute -bottom-6 left-1/2 transform -translate-x-1/2 w-12 h-12 rounded-full flex items-center justify-center overflow-hidden border-4 border-dark-800 z-10"
            >
              <img
        ...
        <div class="grid grid-cols-2 gap-3">
          <UCard class="bg-dark-800 border-dark-700">
            <div class="flex items-center gap-3">
              ...
              >
                <UIcon name="i-lucide-users" class="w-4 h-4 text-white" />
              </div>
              <div>
          ...
          <UCard class="bg-dark-800 border-dark-700">
            <div class="flex items-center gap-3">
              ...
              >
                <UIcon name="i-lucide-hash" class="w-4 h-4 text-white" />
              </div>
              <div>
                <p class="text-lg font-bold text-white">
                  {{ channelStore.channels?.length || 0 }}
              ...
              <div class="lg:col-span-2 space-y-6">
                <div class="mb-8">
                  ...
                  <p class="text-gray-400">
                    Quản lý và tùy chỉnh máy chủ của bạn. Thay đổi cài đặt, quản
                    lý thành viên, và nhiều hơn nữa.
                  </p>
                </div>
