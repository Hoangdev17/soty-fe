...
// Animation classes for blob effect
useHead({
  style: [
    {
      innerHTML: `
...
<template>
  <div
    class="min-h-screen bg-gradient-to-br from-indigo-600 via-purple-600 to-blue-600 relative overflow-hidden"
  >
    ...
    <!-- Features Section -->
    <OrganismsFeatureCard />

    <!-- Call to Action -->
    <OrganismsCallToAction />
  </div>
</template>
